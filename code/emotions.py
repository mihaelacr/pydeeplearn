...
def deepbeliefKanadeCV(big=False):
  ...
  params =[(0.01, 0.01, 0.9),  (0.01, 0.05, 0.9),  (0.05, 0.01, 0.9),  (0.05, 0.5, 0.9),
           (0.01, 0.01, 0.95), (0.01, 0.05, 0.95), (0.05, 0.01, 0.95), (0.05, 0.5, 0.95),
           (0.01, 0.01, 0.99), (0.01, 0.05, 0.99), (0.05, 0.01, 0.99), (0.05, 0.5, 0.99)]
