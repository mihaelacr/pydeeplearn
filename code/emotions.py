...
def deepbeliefPIECV(big=False):
  ...
  # TODO: try boosting for CV in order to increase the number of folds
  params =[(00.1, 0.01, 0.9),  (0.01, 0.05, 0.9),  (0.005, 0.01, 0.9),  (0.005, 0.005, 0.9),
           (00.1, 0.01, 0.95), (0.01, 0.05, 0.95), (0.005, 0.01, 0.95), (0.005, 0.005, 0.95),
           (00.1, 0.01, 0.99), (0.01, 0.05, 0.99), (0.005, 0.01, 0.99), (0.005, 0.005, 0.99)]
