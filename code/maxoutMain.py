...
def MultiPIEmain():
  h0 = maxout.Maxout(layer_name='h0', num_units=1500, num_pieces=3, W_lr_scale=1.0, irange=0.005, b_lr_scale=1.0)
  h1 = maxout.Maxout(layer_name='h1', num_units=1500, num_pieces=3, W_lr_scale=1.0, irange=0.005, b_lr_scale=1.0)
  h2 = maxout.Maxout(layer_name='h2', num_units=1500, num_pieces=3, W_lr_scale=1.0, irange=0.005, b_lr_scale=1.0)
