...
# TODO: max_col_norm
h0 = maxout.Maxout(layer_name='h0', num_units=1200, num_pieces=2,
                    W_lr_scale=0.5, b_lr_scale=0.5, sparse_init=40)

h1 = maxout.Maxout(layer_name='h1', num_units=1200, num_pieces=2,
                    W_lr_scale=0.5, b_lr_scale=0.5, sparse_init=40)
